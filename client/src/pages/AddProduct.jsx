...
const AddProduct = () => {
  ...
  return (
    <>
      <div className="h-[150px] bg-white flex mt-30 justify-center  items-center">
        <form class="w-[390px] mt-20 h-15  bg-grey rounded-lg ml-auto shadow-lg" action="">
          <div className="rounded border border-blue-700 p-5 w-[390px] h-[345px]">
            <h1 className="text-7m text-center  text-black hover:cursor-pointer text-md font-bold">Add Product</h1>
            ...
            <div className="flex justify-center">
              <button onClick={handleAdd} className="py-1 px-5 bg-black text-white p-5 rounded hover:bg-blue-400 hover:text-white m-2 ">Add</button>
              <button onClick={handleCancel} className="py-1 px-5 bg-black text-white p-5 rounded hover:bg-red-400 hover:text-white m-2 ml-auto">Cancel</button>
            </div>
